...
async def form_post(request: Request):
    output = "upload file"
    return templates.TemplateResponse('home1.html', context={'request': request, 'result': output})
...
async def upload1(request: Request, file1: UploadFile = File(...)):
    ...
    return templates.TemplateResponse('home1.html', context={'request': request, 'result': test1})
